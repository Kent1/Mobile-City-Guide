 ...
 * @author Allard Hugo
 */
public class Itinerary extends Application implements Iterable<POI> {
   ...
   * 
   * @return the total duration of all <code>POI</code>s in this
   *         <code>Itinerary</code>.
   */
   ...
   * 
   * @return the total cost of all <code>POI</code>s in this
   *         <code>Itinerary</code>.
   */
