...
public class Itinerary{
   ...
   * 
   * @param poi the <code>POI</code> to add.
   */
   ...
   * 
   * @param poi the <code>POI</code> to search for.
   * @return <code>true</code> if the <code>POI</code> is present, <code>false</code> otherwise.
   */
   ...
   * 
   * @param poi the <code>POI</code> to remove.
   */
   ...
   *  
   * @param list a <code>List</code> representing an <code>Itinerary</code>.
   */
  ...
  /**
   * Returns the <code>List</code> with all the <code>POI</code>s in this <code>Itinerary</code>.
   * 
   * @return a <code>Set</code> with all the <code>POI</code>s in this <code>Itinerary</code>.
   */
